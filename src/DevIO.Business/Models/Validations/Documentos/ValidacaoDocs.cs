...
namespace DevIO.Business.Models.Validations.Documentos
{
    public class CpfValidacao
    {
        ...
        private static bool TemDigitosValidos(string valor)
        {
            ...
            var digitoVarificador = new DigitoVerificador(number)
                .ComMultiplicadoresDeAte(2, 11)
                .Substituindo("0", 10, 11);

            var firstDigit = digitoVarificador.CalculaDigito();
            digitoVarificador.AddDigito(firstDigit);
            var secondDigit = digitoVarificador.CalculaDigito();
    ...
    public class DigitoVerificador
    {
        ...
        private readonly IDictionary<int, string> _substituidores = new Dictionary<int, string>();
        ...
        private string GetDigitSum()
        {
            ...
            return _substituidores.ContainsKey(resultado) ? _substituidores[resultado] : resultado.ToString();
        }
    }
